 ...
 * 
 */
@WebServiceClient(name = "ProductWS", targetNamespace = "http://webservice.soap_server.example.com/", wsdlLocation = "http://localhost:8088/ws?wsdl")
    ...
    extends Service
{
    ...
    private static final QName PRODUCTWS_QNAME = new QName("http://webservice.soap_server.example.com/", "ProductWS");
    ...
    public ProductWebService getProductWebServicePort() {
        return super.getPort(new QName("http://webservice.soap_server.example.com/", "ProductWebServicePort"), ProductWebService.class);
    }
    ...
    public ProductWebService getProductWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.soap_server.example.com/", "ProductWebServicePort"), ProductWebService.class, features);
    }
